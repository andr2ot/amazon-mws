 ...
 * 
 * 
 * MarketplaceWebServiceClient is implementation of MarketplaceWebService based on the Apache <a
...
public class MarketplaceWebServiceClient implements MarketplaceWebService {
   ...
   */
  public MarketplaceWebServiceClient(final String awsAccessKeyId,
      final String awsSecretAccessKey, final String applicationName,
      final String applicationVersion) {
    this(awsAccessKeyId, awsSecretAccessKey, applicationName,
        applicationVersion, new MarketplaceWebServiceConfig());
  }

  /**
   * Constructs MarketplaceWebServiceClient with AWS Access Key ID, AWS Secret Key and max number of threads to spawn
  ...
  public MarketplaceWebServiceClient(final String awsAccessKeyId,
      final String awsSecretAccessKey, final String applicationName,
      final String applicationVersion, final int maxAsyncThreads) {
    this(awsAccessKeyId, awsSecretAccessKey, applicationName,
        applicationVersion, new MarketplaceWebServiceConfig()
            .withMaxAsyncThreads(maxAsyncThreads));
  }

  /**
   * Constructs MarketplaceWebServiceClient with AWS Access Key ID, AWS Secret Key and MarketplaceWebServiceConfig. Use
   * MarketplaceWebServiceConfig to pass additional configuration that affects how service is being called.
   * 
   * @param awsAccessKeyId AWS Access Key ID
   * @param awsSecretAccessKey AWS Secret Access Key
  ...
  public MarketplaceWebServiceClient(final String awsAccessKeyId,
      final String awsSecretAccessKey, final String applicationName,
      final String applicationVersion, final MarketplaceWebServiceConfig config) {
    this.awsAccessKeyId = awsAccessKeyId;
    this.awsSecretAccessKey = awsSecretAccessKey;
    this.config = config;
    httpClient = configureHttpClient(applicationName, applicationVersion);
    asyncExecutor = new ThreadPoolExecutor(config.getMaxAsyncThreads(),
        ...
        new ArrayBlockingQueue<Runnable>(config.getMaxAsyncQueueSize()) {
          ...
          public Thread newThread(final Runnable task) {
            Thread thread = new Thread(task,
                "MarketplaceWebServiceClient-Thread-"
   ...
   * Get Report
   * 
   * The GetReport operation returns the contents of a report. Reports can potentially be very large (>100MB) which is
   * why we only return one report at a time, and in a streaming fashion.
   * 
   ...
   */
  @Override
  public GetReportResponse getReport(final GetReportRequest request)
      throws MarketplaceWebServiceException {
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   *       MarketplaceWebServiceException exception = MarketplaceWebServiceException.class
   *           .cast(e);
  ...
  public Future<GetReportResponse> getReportAsync(final GetReportRequest request) {
    Future<GetReportResponse> response = asyncExecutor
        .submit(new Callable<GetReportResponse>() {
  ...
  public GetReportScheduleCountResponse getReportScheduleCount(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportScheduleCountResponse.class,
        convertGetReportScheduleCount(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportScheduleCountResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetReportScheduleCountResponse> getReportScheduleCountAsync(
    ...
    Future<GetReportScheduleCountResponse> response = asyncExecutor
        .submit(new Callable<GetReportScheduleCountResponse>() {
          ...
          @Override
          public GetReportScheduleCountResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetReportRequestListByNextTokenResponse getReportRequestListByNextToken(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportRequestListByNextTokenResponse.class,
        convertGetReportRequestListByNextToken(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportRequestListByNextTokenResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   * 
   * @param request GetReportRequestListByNextTokenRequest request
   * @return Future&lt;GetReportRequestListByNextTokenResponse&gt; future pointer to
  ...
  public Future<GetReportRequestListByNextTokenResponse> getReportRequestListByNextTokenAsync(
    ...
    Future<GetReportRequestListByNextTokenResponse> response = asyncExecutor
        .submit(new Callable<GetReportRequestListByNextTokenResponse>() {
          ...
          @Override
          public GetReportRequestListByNextTokenResponse call()
              throws MarketplaceWebServiceException {
  ...
  public UpdateReportAcknowledgementsResponse updateReportAcknowledgements(
      ...
      throws MarketplaceWebServiceException {
    return invoke(UpdateReportAcknowledgementsResponse.class,
        convertUpdateReportAcknowledgements(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return UpdateReportAcknowledgementsResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<UpdateReportAcknowledgementsResponse> updateReportAcknowledgementsAsync(
    ...
    Future<UpdateReportAcknowledgementsResponse> response = asyncExecutor
        .submit(new Callable<UpdateReportAcknowledgementsResponse>() {
          ...
          @Override
          public UpdateReportAcknowledgementsResponse call()
              throws MarketplaceWebServiceException {
   ...
   * Submit Feed
   * 
   * Uploads a file for processing together with the necessary metadata to process the file, such as which type of feed
   * it is. PurgeAndReplace if true means that your existing e.g. inventory is wiped out and replace with the contents
   ...
   */
  @Override
  public SubmitFeedResponse submitFeed(final SubmitFeedRequest request)
      throws MarketplaceWebServiceException {
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return SubmitFeedResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<SubmitFeedResponse> submitFeedAsync(
      final SubmitFeedRequest request) {
    Future<SubmitFeedResponse> response = asyncExecutor
        .submit(new Callable<SubmitFeedResponse>() {

          @Override
          public SubmitFeedResponse call()
              throws MarketplaceWebServiceException {
   ...
   * 
   * Uploads a file from disk for processing together with the necessary metadata to process the file, such as which
   * type of feed it is. PurgeAndReplace if true means that your existing e.g. inventory is wiped out and replace with
   * the contents of this feed - use with caution (the default is false).
   * 
   * This function assumes the Content MD5 value is unset in the request, and will set it before making the Submit Feed
   * request. The Feed Content must be stored on disk, as the assumption is that the content is accessed through a
   * FileInputStream.
   * 
   ...
   */
  @Override
  public SubmitFeedResponse submitFeedFromFile(final SubmitFeedRequest request)
      throws MarketplaceWebServiceException {

    try {
      String contentMd5 = computeContentMD5HeaderValue((FileInputStream) request
          .getFeedContent());
   ...
   */
  @Override
  public Future<SubmitFeedResponse> submitFeedFromFileAsync(
      final SubmitFeedRequest request) {
    Future<SubmitFeedResponse> response = asyncExecutor
        .submit(new Callable<SubmitFeedResponse>() {
   ...
   * Get Report Count
   * 
   * returns a count of reports matching your criteria; by default, the number of reports generated in the last 90 days,
   ...
   */
  @Override
  public GetReportCountResponse getReportCount(
      final GetReportCountRequest request)
      throws MarketplaceWebServiceException {
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportCountResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<GetReportCountResponse> getReportCountAsync(
      final GetReportCountRequest request) {
    Future<GetReportCountResponse> response = asyncExecutor
        .submit(new Callable<GetReportCountResponse>() {

          @Override
          public GetReportCountResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetFeedSubmissionListByNextTokenResponse getFeedSubmissionListByNextToken(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetFeedSubmissionListByNextTokenResponse.class,
        convertGetFeedSubmissionListByNextToken(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetFeedSubmissionListByNextTokenResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   * 
   * @param request GetFeedSubmissionListByNextTokenRequest request
   * @return Future&lt;GetFeedSubmissionListByNextTokenResponse&gt; future pointer to
  ...
  public Future<GetFeedSubmissionListByNextTokenResponse> getFeedSubmissionListByNextTokenAsync(
    ...
    Future<GetFeedSubmissionListByNextTokenResponse> response = asyncExecutor
        .submit(new Callable<GetFeedSubmissionListByNextTokenResponse>() {
          ...
          @Override
          public GetFeedSubmissionListByNextTokenResponse call()
              throws MarketplaceWebServiceException {
   ...
   * 
   * cancels feed submissions - by default all of the submissions of the last 30 days that have not started processing
   * 
  ...
  public CancelFeedSubmissionsResponse cancelFeedSubmissions(
      ...
      throws MarketplaceWebServiceException {
    return invoke(CancelFeedSubmissionsResponse.class,
        convertCancelFeedSubmissions(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return CancelFeedSubmissionsResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<CancelFeedSubmissionsResponse> cancelFeedSubmissionsAsync(
    ...
    Future<CancelFeedSubmissionsResponse> response = asyncExecutor
        .submit(new Callable<CancelFeedSubmissionsResponse>() {
          ...
          @Override
          public CancelFeedSubmissionsResponse call()
              throws MarketplaceWebServiceException {
   ...
   */
  @Override
  public RequestReportResponse requestReport(final RequestReportRequest request)
      throws MarketplaceWebServiceException {
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return RequestReportResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<RequestReportResponse> requestReportAsync(
      final RequestReportRequest request) {
    Future<RequestReportResponse> response = asyncExecutor
        .submit(new Callable<RequestReportResponse>() {

          @Override
          public RequestReportResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetFeedSubmissionCountResponse getFeedSubmissionCount(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetFeedSubmissionCountResponse.class,
        convertGetFeedSubmissionCount(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetFeedSubmissionCountResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetFeedSubmissionCountResponse> getFeedSubmissionCountAsync(
    ...
    Future<GetFeedSubmissionCountResponse> response = asyncExecutor
        .submit(new Callable<GetFeedSubmissionCountResponse>() {
          ...
          @Override
          public GetFeedSubmissionCountResponse call()
              throws MarketplaceWebServiceException {
   ...
   * 
   * cancels report request that have not yet started processing, by default all those within the last 90 days
   * 
   ...
   */
  @Override
  public CancelReportRequestsResponse cancelReportRequests(
      final CancelReportRequestsRequest request)
      throws MarketplaceWebServiceException {
    return invoke(CancelReportRequestsResponse.class,
        convertCancelReportRequests(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return CancelReportRequestsResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<CancelReportRequestsResponse> cancelReportRequestsAsync(
      final CancelReportRequestsRequest request) {
    Future<CancelReportRequestsResponse> response = asyncExecutor
        .submit(new Callable<CancelReportRequestsResponse>() {

          @Override
          public CancelReportRequestsResponse call()
              throws MarketplaceWebServiceException {
   ...
   * Get Report List
   * 
   * returns a list of reports; by default the most recent ten reports, regardless of their acknowledgment status
   * 
   ...
   */
  @Override
  public GetReportListResponse getReportList(final GetReportListRequest request)
      throws MarketplaceWebServiceException {
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportListResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<GetReportListResponse> getReportListAsync(
      final GetReportListRequest request) {
    Future<GetReportListResponse> response = asyncExecutor
        .submit(new Callable<GetReportListResponse>() {

          @Override
          public GetReportListResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetFeedSubmissionResultResponse getFeedSubmissionResult(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetFeedSubmissionResultResponse.class,
        convertGetFeedSubmissionResult(request), request);
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetFeedSubmissionResultResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetFeedSubmissionResultResponse> getFeedSubmissionResultAsync(
    ...
    Future<GetFeedSubmissionResultResponse> response = asyncExecutor
        .submit(new Callable<GetFeedSubmissionResultResponse>() {
          ...
          @Override
          public GetFeedSubmissionResultResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetFeedSubmissionListResponse getFeedSubmissionList(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetFeedSubmissionListResponse.class,
        convertGetFeedSubmissionList(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetFeedSubmissionListResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetFeedSubmissionListResponse> getFeedSubmissionListAsync(
    ...
    Future<GetFeedSubmissionListResponse> response = asyncExecutor
        .submit(new Callable<GetFeedSubmissionListResponse>() {
          ...
          @Override
          public GetFeedSubmissionListResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetReportRequestListResponse getReportRequestList(
      final GetReportRequestListRequest request)
      throws MarketplaceWebServiceException {
    return invoke(GetReportRequestListResponse.class,
        convertGetReportRequestList(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportRequestListResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<GetReportRequestListResponse> getReportRequestListAsync(
      final GetReportRequestListRequest request) {
    Future<GetReportRequestListResponse> response = asyncExecutor
        .submit(new Callable<GetReportRequestListResponse>() {

          @Override
          public GetReportRequestListResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetReportScheduleListByNextTokenResponse getReportScheduleListByNextToken(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportScheduleListByNextTokenResponse.class,
        convertGetReportScheduleListByNextToken(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportScheduleListByNextTokenResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   * 
   * @param request GetReportScheduleListByNextTokenRequest request
   * @return Future&lt;GetReportScheduleListByNextTokenResponse&gt; future pointer to
  ...
  public Future<GetReportScheduleListByNextTokenResponse> getReportScheduleListByNextTokenAsync(
    ...
    Future<GetReportScheduleListByNextTokenResponse> response = asyncExecutor
        .submit(new Callable<GetReportScheduleListByNextTokenResponse>() {
          ...
          @Override
          public GetReportScheduleListByNextTokenResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetReportListByNextTokenResponse getReportListByNextToken(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportListByNextTokenResponse.class,
        convertGetReportListByNextToken(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportListByNextTokenResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetReportListByNextTokenResponse> getReportListByNextTokenAsync(
    ...
    Future<GetReportListByNextTokenResponse> response = asyncExecutor
        .submit(new Callable<GetReportListByNextTokenResponse>() {
          ...
          @Override
          public GetReportListByNextTokenResponse call()
              throws MarketplaceWebServiceException {
   ...
   * 
   * Creates, updates, or deletes a report schedule for a given report type, such as order reports in particular.
   * 
  ...
  public ManageReportScheduleResponse manageReportSchedule(
      final ManageReportScheduleRequest request)
      throws MarketplaceWebServiceException {
    return invoke(ManageReportScheduleResponse.class,
        convertManageReportSchedule(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return ManageReportScheduleResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
   ...
   */
  @Override
  public Future<ManageReportScheduleResponse> manageReportScheduleAsync(
      final ManageReportScheduleRequest request) {
    Future<ManageReportScheduleResponse> response = asyncExecutor
        .submit(new Callable<ManageReportScheduleResponse>() {

          @Override
          public ManageReportScheduleResponse call()
              throws MarketplaceWebServiceException {
   ...
   * 
   * returns a count of report requests; by default all the report requests in the last 90 days
   * 
  ...
  public GetReportRequestCountResponse getReportRequestCount(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportRequestCountResponse.class,
        convertGetReportRequestCount(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportRequestCountResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetReportRequestCountResponse> getReportRequestCountAsync(
    ...
    Future<GetReportRequestCountResponse> response = asyncExecutor
        .submit(new Callable<GetReportRequestCountResponse>() {
          ...
          @Override
          public GetReportRequestCountResponse call()
              throws MarketplaceWebServiceException {
  ...
  public GetReportScheduleListResponse getReportScheduleList(
      ...
      throws MarketplaceWebServiceException {
    return invoke(GetReportScheduleListResponse.class,
        convertGetReportScheduleList(request));
  }
   ...
   * <p/>
   * If response is ready, call to <code>future.get()</code> will return GetReportScheduleListResponse.
   * <p/>
   * If response is not ready, call to <code>future.get()</code> will block the calling thread until response is
   * returned.
   * <p/>
  ...
  public Future<GetReportScheduleListResponse> getReportScheduleListAsync(
    ...
    Future<GetReportScheduleListResponse> response = asyncExecutor
        .submit(new Callable<GetReportScheduleListResponse>() {
          ...
          @Override
          public GetReportScheduleListResponse call()
              throws MarketplaceWebServiceException {
  ...
  /**
   * Remove all leading whitespace, trailing whitespace, repeated whitespace and replace any interior whitespace with a
   * single space
   */
  ...
  public static String quoteAppName(final String s) {
    return clean(s).replace("\\", "\\\\").replace("/", "\\/");
  }

  public static String quoteAppVersion(final String s) {
    return clean(s).replace("\\", "\\\\").replace("(", "\\(");
  }

  public static String quoteAttributeName(final String s) {
    return clean(s).replace("\\", "\\\\").replace("=", "\\=");
  }

  public static String quoteAttributeValue(final String s) {
    return clean(s).replace("\\", "\\\\").replace(";", "\\;")
        .replace(")", "\\)");
  }

  private static final String mwsClientLibraryVersion = "2012-09-28";
   ...
   * 
   */
  private HttpClient configureHttpClient(final String applicationName,
      final String applicationVersion) {
    ...
    defaultHeaders.add(new BasicHeader("X-Amazon-User-Agent", config
        .getUserAgent()));
    ...
    if (config.isSetProxyHost() && config.isSetProxyPort()) {
      ...
      final HttpHost hostConfiguration = new HttpHost(config.getProxyHost(),
          config.getProxyPort(), (usesHttps(config.getServiceURL()) ? "https"
              : "http"));
      httpContext = new BasicHttpContext();
   ...
   */
  private void copyResponseToOutputStream(final InputStream from,
  ...
  private void addRequiredParameters(final Map<String, String> parameters)
  ...
  private String getSubmitFeedUrlParameters(final Map<String, String> parameters)
  ...
  private <T> T invoke(final Class<T> clazz,
  ...
  @SuppressWarnings("serial")
  private <T, U> T invoke(final Class<T> clazz,
      final Map<String, String> parameters, final U request)
      throws MarketplaceWebServiceException {
    ...
    try {
      ...
      responseHeaderMetadataSetter = clazz.getMethod(
          "setResponseHeaderMetadata", ResponseHeaderMetadata.class);
      ...
      if (request instanceof SubmitFeedRequest) {
        ...
        method = new HttpPost(config.getServiceURL() + "?"
            + getSubmitFeedUrlParameters(parameters));
        ...
        /*
         * Set content type and encoding - encoding and charset are ignored right now because octet-stream is the only
         * supported transport of MWS feeds.
         */
        method.addHeader(new BasicHeader("Content-Type", sfr.getContentType()
            .toString()));
        ...
        log.debug("Done adding additional required parameters. Parameters now: "
            + parameters);
      }
      ...
      do {
        ...
        try {
          ...
          if (!isStreamingResponse) {
            // SubmitFeed
            responseBodyString = getResponsBodyAsString(postResponse
          ...
          if (status == HttpStatus.SC_OK && responseBodyString != null) {
            ...
            log.debug("Attempting to unmarshal into the " + actionName
                + "Response type...");
            response = clazz.cast(getUnmarshaller().unmarshal(
                new StreamSource(new StringReader(responseBodyString))));
            responseHeaderMetadataSetter.invoke(response,
            ...
            OutputStream originalOs = (OutputStream) outputStreamGetter.invoke(
                request, new Object[0]);

            MessageDigest messageDigest = MessageDigest.getInstance("MD5");
            DigestOutputStream os = new DigestOutputStream(originalOs,
                messageDigest);
            ...
            {
              requestIdFromHeader = getFirstHeader(postResponse,
                  "x-amz-request-id").getValue();

              // Avoid use of the JDK-1.6-only isEmpty() call.
              if (requestIdFromHeader == null
                  || requestIdFromHeader.length() == 0) {
                throw new MarketplaceWebServiceException(
            ...
            returnedContentMD5 = getFirstHeader(postResponse, "Content-MD5")
                .getValue();

            copyResponseToOutputStream(postResponse.getEntity().getContent(),
                os);

            // Streaming-response-as-unnamed-body responses from MWS
            // must also carry a Content-MD5 header and it must
            // match the calculated MD5 for the body.
            String calculatedContentMD5 = new String(
                Base64.encodeBase64(messageDigest.digest()), "UTF-8");
            if (!calculatedContentMD5.equals(returnedContentMD5)) {
              throw new MarketplaceWebServiceException(
                  "Content-MD5 HTTP header transmitted by MWS ("
                      + returnedContentMD5 + ") "
                      + "does not match the calculated MD5 ("
                      + calculatedContentMD5 + ") " + "in request id "
                      + requestIdFromHeader + " - please contact Amazon");
            }
            ...
            if (clazz == GetFeedSubmissionResultResponse.class) {
              ...
              r.setGetFeedSubmissionResultResult(new GetFeedSubmissionResultResult(
                  returnedContentMD5));
            ...
            if (status == HttpStatus.SC_INTERNAL_SERVER_ERROR
              ...
              com.amazonaws.mws.model.Error error = errorResponse.getError()
                  .get(0);
              ...
              if (status == HttpStatus.SC_SERVICE_UNAVAILABLE
                ...
                shouldRetry = false;
                throw new MarketplaceWebServiceException(
                    (((request instanceof SubmitFeedRequest) && (error.getType().equals("Receiver"))) ? error
                        .getMessage()
                        + " [Cannot retry SubmitFeed request: must reset InputStream to retry.]"
                        : error.getMessage()), status, error.getCode(), error
                        .getType(), errorResponse.getRequestId(), errorResponse
                        .toXML(), responseHeaderMetadata);
              }
            }
          }
        } catch (JAXBException je) {
          /*
           * Response cannot be unmarshalled neither as <Action>Response or ErrorResponse types. Checking for other
           * possible errors.
           */

          log.debug("Caught JAXBException", je);
          log.debug("Response cannot be unmarshalled neither as " + actionName
              + "Response or ErrorResponse types."
              + "Checking for other possible errors.");

          MarketplaceWebServiceException awse = processErrors(
              responseBodyString, status, responseHeaderMetadata);
  ...
  private Header getFirstHeader(final HttpResponse response,
  ...
  private ResponseHeaderMetadata getResponseHeaderMetadata(
    ...
    return new ResponseHeaderMetadata(requestId != null ? requestId.getValue()
        : null, responseContext != null ? responseContext.getValue() : null,
   ...
   */
  private String computeContentMD5HeaderValue(final FileInputStream fis)
   ...
   */
  private String getResponsBodyAsString(final InputStream input)
      throws IOException {
   ...
   */
  private boolean pauseIfRetryNeeded(final int retries)
   ...
   */
  private void addRequiredParametersToRequest(final HttpPost method,
      final Map<String, String> parameters) throws SignatureException,
  ...
  private MarketplaceWebServiceException processErrors(
      final String responseString, final int status,
      final ResponseHeaderMetadata metadata) {
      ...
      if (matcher.matches()) {
        ...
        if (matcher.matches()) {
          ...
          log.error("Service Error. Response Status: " + status
              + ". Received message: " + responseString);
        }
      }
    } else {
      ex = new MarketplaceWebServiceException("Internal Error", status,
  ...
  /**
   * Computes RFC 2104-compliant HMAC signature for request parameters Implements AWS Signature, as per following spec:
   * 
   * If Signature Version is 1, it performs the following:
   * 
   * Sorts all parameters (including SignatureVersion and excluding Signature, the value of which is being created),
   * ignoring case.
   * 
   * Iterate over the sorted list and append the parameter name (in original case) and then its value. It will not
   * URL-encode the parameter values before constructing this string. There are no separators.
   * 
   * If Signature Version is 2, string to sign is based on following:
   * 
   * 1. The HTTP Request Method followed by an ASCII newline (%0A) 2. The HTTP Host header in the form of lowercase
   * host, followed by an ASCII newline. 3. The URL encoded HTTP absolute path component of the URI (up to but not
   * including the query string parameters); if this is empty use a forward '/'. This parameter is followed by an ASCII
   * newline. 4. The concatenation of all query string components (names and values) as UTF-8 characters which are URL
   * encoded as per RFC 3986 (hex characters MUST be uppercase), sorted using lexicographic byte ordering. Parameter
   * names are separated from their values by the '=' character (ASCII character 61), even if the value is empty. Pairs
   * of parameter and values are separated by the '&' character (ASCII code 38).
   * 
   */
  private String signParameters(final Map<String, String> parameters,
   ...
   */
  private String calculateStringToSignV2(final Map<String, String> parameters)
      throws SignatureException {
  ...
  private static boolean usesHttps(final String url) {
    URL urlToCheck;
    try {
  ...
  private static int extractPortNumber(final String url, final boolean usesHttps) {
    URL urlToCheck;
    try {
      urlToCheck = new URL(url);
    } catch (MalformedURLException e) {
  ...
  private static boolean usesAStandardPort(final String url) {
  ...
  private String urlEncode(final String rawValue) {
    String value = rawValue == null ? "" : rawValue;
    String encoded = null;
    try {
      encoded = URLEncoder.encode(value, DEFAULT_ENCODING).replace("+", "%20")
   ...
   * 
   */
  private String sign(final String data, final String key,
      final String algorithm) throws SignatureException {
    byte[] signature;
    try {
   ...
   */
  private Map<String, String> convertGetReport(final GetReportRequest request) {
   ...
   */
  private Map<String, String> convertGetReportScheduleCount(
      final GetReportScheduleCountRequest request) {
   ...
   */
  private Map<String, String> convertGetReportRequestListByNextToken(
      final GetReportRequestListByNextTokenRequest request) {
   ...
   */
  private Map<String, String> convertUpdateReportAcknowledgements(
      final UpdateReportAcknowledgementsRequest request) {
    ...
    if (request.isSetReportIdList()) {
      ...
      for (String id : idList) {
        params.put(
            "ReportIdList" + "." + "Id" + "." + (idList.indexOf(id) + 1), id);
      }
    }
   ...
   */
  private Map<String, String> convertSubmitFeed(final SubmitFeedRequest request) {
   ...
   */
  private Map<String, String> convertGetReportCount(
      final GetReportCountRequest request) {
   ...
   */
  private Map<String, String> convertCancelFeedSubmissions(
      final CancelFeedSubmissionsRequest request) {
    ...
    if (request.isSetFeedTypeList()) {
      ...
      for (String type : typeList) {
        params.put(
            "FeedTypeList" + "." + "Type" + "." + (typeList.indexOf(type) + 1),
            type);
      }
    }
   ...
   */
  private Map<String, String> convertRequestReport(
      final RequestReportRequest request) {
   ...
   */
  private Map<String, String> convertGetFeedSubmissionCount(
      final GetFeedSubmissionCountRequest request) {
    ...
    if (request.isSetFeedProcessingStatusList()) {
      StatusList feedProcessingStatusList = request
          .getFeedProcessingStatusList();
      java.util.List<String> statusList = feedProcessingStatusList.getStatus();
      for (String status : statusList) {
        params.put("FeedProcessingStatusList" + "." + "Status" + "."
            + (statusList.indexOf(status) + 1), status);
      }
    }
    if (request.isSetSubmittedFromDate()) {
      params.put("SubmittedFromDate", request.getSubmittedFromDate() + "");
   ...
   */
  private Map<String, String> convertCancelReportRequests(
      final CancelReportRequestsRequest request) {
    ...
    if (request.isSetReportProcessingStatusList()) {
      StatusList reportProcessingStatusList = request
          .getReportProcessingStatusList();
      java.util.List<String> statusList = reportProcessingStatusList
          .getStatus();
      for (String status : statusList) {
        params.put("ReportProcessingStatusList" + "." + "Status" + "."
            + (statusList.indexOf(status) + 1), status);
      }
    }
   ...
   */
  private Map<String, String> convertGetReportList(
      final GetReportListRequest request) {
   ...
   */
  private Map<String, String> convertGetFeedSubmissionResult(
      final GetFeedSubmissionResultRequest request) {
   ...
   */
  private Map<String, String> convertGetFeedSubmissionList(
      final GetFeedSubmissionListRequest request) {
   ...
   */
  private Map<String, String> convertGetReportRequestList(
      final GetReportRequestListRequest request) {
   ...
   */
  private Map<String, String> convertGetReportListByNextToken(
      final GetReportListByNextTokenRequest request) {
   ...
   */
  private Map<String, String> convertManageReportSchedule(
      final ManageReportScheduleRequest request) {
   ...
   */
  private Map<String, String> convertGetReportRequestCount(
      final GetReportRequestCountRequest request) {
   ...
   */
  private Map<String, String> convertGetReportScheduleList(
      final GetReportScheduleListRequest request) {
