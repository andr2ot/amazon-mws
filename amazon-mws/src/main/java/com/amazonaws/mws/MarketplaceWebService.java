...
public interface MarketplaceWebService {
   ...
   * 
   * cancels report requests that have not yet started processing, by default all those within the last 90 days
   * 
   ...
   * Get Report List
   * 
   * returns a list of reports; by default the most recent ten reports, regardless of their acknowledgement status
   * 
